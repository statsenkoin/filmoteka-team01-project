export default function createMarkupModalWindow(data, filmGenres) {
    const { title, poster_path, vote_average, vote_count, popularity, original_title, overview} = data;
      ...
      <div class="film-information">
        ...
        <table class="rating-table">
          <tr>
            ...
            <td class="table-inf"><span class="rating">${vote_average.toFixed(1)}</span> / ${vote_count}</td>
          </tr>
          <tr>
